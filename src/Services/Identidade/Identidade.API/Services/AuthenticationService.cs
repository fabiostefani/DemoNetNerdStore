...
public class AuthenticationService
{
    ...
    private async Task<RefreshToken> GerarRefreshToken(string email)
    {
        ...
        {
            Username = email,
            DataExpiracao = DateTime.UtcNow.AddHours(_appTokenSettingsSettings.RefreshTokenExpiration)
        };
    ...
    public async Task<RefreshToken?> ObterRefreshToken(Guid refreshToken)
    {
        ...
        return token != null && token.DataExpiracao.ToLocalTime() > DateTime.Now ? token : null;
    }
}